...
2. Real_Estate_Prediction_Model-Copy2.ipynb - Jupyter notebook containing data preprocessing, exploratory analysis, feature engineering, model training, and evaluation.
3. app.py - Flask web application that provides a user interface for predicting real estate prices based on user input.
4. scaler.pickle - Saved model components used for prediction in the web application.
